...
const Hero = () => {
    return (
        ...
        <div className='container pt-[50px] mx-auto h-[100vh]'>
            <div className='w-[90%] lg:w-[860px] mx-auto flex items-center flex-col text-center gap-[20px]'>
                <h1 className='section-title text-[62px]'><span>Dasturlashni</span> biz bilan qulay muhitda o‘rganing</h1>
                <p className='text-[#8A90A5] text-[17px] lg:text-[20px]'>Khan Academy - bu siz izlagan akademiya bo’lib, unda siz juda qisqa muddatda istalgan dasturlash sohasida Junior darajasiga chiqa olasiz! </p>
                <div className='flex flex-col lg:flex-row items-center gap-[10px] my-[20px] w-[80%] lg:w-auto'>
