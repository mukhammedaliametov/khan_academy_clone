  ...
  return (
    <div className="bg-[#F8FAFC]">
      <div className="container py-[40px]">
        ...
        <p className="text-[#8A90A5] text-[20px] w-[400px] lg:w-[483px] mx-auto mb-[40px] text-center">
        ...
        <div className="flex flex-col gap-[20px] lg:grid grid-cols-3 lg:gap-[40px]">
          {strengthsItems.map((item, index) => {
            ...
            return (
              <div key={index} className="bg-white mx-auto w-[380px] p-[30px] group hover:shadow-md transition-all duration-300 cursor-pointer rounded-[10px]">
